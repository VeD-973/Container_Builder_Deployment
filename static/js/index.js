...
const rustyTexture = textureLoader.load('static/rust3.png', function (texture) {
...
function fetchContainerDimensions() {
    return fetch('static/container_info.json')
        .then(response => {
            if (!response.ok) {
...
fetchContainerDimensions().then(dimensions => {
    console.log('Container Width (after fetch):', dimensions.containerWidth);
    console.log('Container Height (after fetch):', dimensions.containerHeight);
    console.log('Container Depth (after fetch):', dimensions.containerDepth);
    ...
    fetch('static/box_coordinates.json')
    ...
    gltfLoader.load('static/group1.gltf', (gltf) => {
